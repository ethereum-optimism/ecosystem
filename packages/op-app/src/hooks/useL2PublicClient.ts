...
export type UseL2PublicClientReturnType = (args: UseL2PublicClientArgs) => { l2PublicClient: PublicClient }

export const useL2PublicClient: UseL2PublicClientReturnType = ({ chainId, type }: UseL2PublicClientArgs) => {
