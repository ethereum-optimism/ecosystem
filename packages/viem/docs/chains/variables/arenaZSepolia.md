...
> `readonly` **name**: `"arena-z-testnet Explorer"` = `'arena-z-testnet Explorer'`
...
[packages/viem/src/chains/sepolia.ts:8](https://github.com/ethereum-optimism/ecosystem/blob/8c869dbb3cc282dd35a61a60d7a8a9cae4a14cae/packages/viem/src/chains/sepolia.ts#L8)
