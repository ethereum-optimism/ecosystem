...
> `readonly` **name**: `"Binary Mainnet Explorer"` = `'Binary Mainnet Explorer'`
...
[packages/viem/src/chains/mainnet.ts:1179](https://github.com/ethereum-optimism/ecosystem/blob/8c869dbb3cc282dd35a61a60d7a8a9cae4a14cae/packages/viem/src/chains/mainnet.ts#L1179)
