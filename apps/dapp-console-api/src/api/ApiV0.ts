...
import type { FaucetRoute } from '@/routes/faucet/FaucetRoute'
import type { MessagesRoute } from '@/routes/messages'
...
export class ApiV0 extends Api {
  ...
  public readonly handler = this.trpc.router({
    ...
    [this.routes.faucetRoute.name]: this.routes.faucetRoute.handler,
    [this.routes.messagesRoute.name]: this.routes.messagesRoute.handler,
  })
